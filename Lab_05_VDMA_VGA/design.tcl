...
proc create_root_design { parentCell } {
  ...
  set vga_out [ create_bd_port -dir O -from 11 -to 0 vga_out ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {54} \
  ...
  # Create instance: rgb888_rgb444_0, and set properties
  set block_name rgb888_rgb444
  set block_cell_name rgb888_rgb444_0
  if { [catch {set rgb888_rgb444_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rgb888_rgb444_0 eq "" } {
  ...
  # Create instance: takk_rgb2gray_0, and set properties
  set block_name takk_rgb2gray
  set block_cell_name takk_rgb2gray_0
  if { [catch {set takk_rgb2gray_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $takk_rgb2gray_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.GEN_F0_VFRAME_SIZE {1066} \
   CONFIG.GEN_F0_VSYNC_HEND {1280} \
   CONFIG.GEN_F0_VSYNC_HSTART {1280} \
   CONFIG.GEN_F0_VSYNC_VEND {1027} \
   CONFIG.GEN_F0_VSYNC_VSTART {1024} \
   CONFIG.GEN_F1_VBLANK_HEND {1280} \
   CONFIG.GEN_F1_VBLANK_HSTART {1280} \
   CONFIG.GEN_F1_VFRAME_SIZE {1066} \
   CONFIG.GEN_F1_VSYNC_HEND {1280} \
   CONFIG.GEN_F1_VSYNC_HSTART {1280} \
   CONFIG.GEN_F1_VSYNC_VEND {1027} \
   CONFIG.GEN_F1_VSYNC_VSTART {1024} \
   CONFIG.GEN_HACTIVE_SIZE {1280} \
   CONFIG.GEN_HFRAME_SIZE {1688} \
   CONFIG.GEN_HSYNC_END {1440} \
   CONFIG.GEN_HSYNC_START {1328} \
   CONFIG.GEN_VACTIVE_SIZE {1024} \
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins takk_rgb2gray_0/s_axis]
  ...
  connect_bd_intf_net -intf_net takk_rgb2gray_0_m_axis [get_bd_intf_pins takk_rgb2gray_0/m_axis] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins takk_rgb2gray_0/clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rgb888_rgb444_0_vga_out [get_bd_ports vga_out] [get_bd_pins rgb888_rgb444_0/vga_out]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins takk_rgb2gray_0/rst_n] [get_bd_pins v_axi4s_vid_out_0/aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins rgb888_rgb444_0/valid_in] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins rgb888_rgb444_0/rgb_in] [get_bd_pins v_axi4s_vid_out_0/vid_data]
